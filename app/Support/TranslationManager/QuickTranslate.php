...
class QuickTranslate extends Page implements HasForms
{
    ...
    protected static string $view = 'quick-translate';
            ...
            'selectForm' => $this->makeForm()
                ->schema([
                    Select::make('selectedLocale')
                        ...
                        ->label(__('translations.quick-translate-select-locale'))
                        ->reactive()
            ...
            'enterForm' => $this->makeForm()
                ->schema([
                    Textarea::make('enteredTranslation')
                        ->label(__('translations.quick-translate-enter', ['lang' => $this->selectedLocale]))
                        ->required(),
                ]),
        ];
    }
    ...
    {
        return __('translations.quick-translate');
    }
}
